...
export class AuthService {
  ...
  registerUser(user) {
    ...
    return this._http
      .put(environment.BACKENDURL + '/user/register', user, { headers: headers })
      .map(res => res.json());
  }
  ...
  registerCivilityUser(nickname, civility) {
    ...
    headers
      .append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/register-civility',
      {
        nickname: nickname,
        civility: civility
      },
  ...
  registerExtraDetails(nickname, details) {
    ...
    headers
      .append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/register-extra-details',
      {
        nickname: nickname,
  ...
  loginUser(user) {
    ...
    return this._http
      .post(environment.BACKENDURL + '/user/login', user, { headers: headers })
      .map(res => res.json());
  }
  ...
  getProfile() {
    ...
    return this._http
      .get(environment.BACKENDURL + '/user/profile', { headers: headers })
      .map(res => res.json());
  }
  ...
  findUserbyEmail(mail) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/find-user-by-mail', mail, { headers: headers })
      .map(res => res.json());
  }
  ...
  */
  isPseudoAvailable(nickname) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/nickname-availability', {
        'nickname': nickname
      }, {
        headers: headers
      })
  ...
  updateProfile(newUserProfile) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/update-profile',
      newUserProfile, {
        headers: headers
      })
      .map(res =>
  ...
  lostPassword(userMail) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/lost-password', userMail, {
        headers: headers
      })
      .map(res => res.json());
  };
  ...
  */
  passwordChange(oldPass, newPass) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/change-password', {
 ...
 */
  searchMembers(itemToFind) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/search-member', {
  ...
  */
  searchMemberByNickname(nickname: String) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/search-member-by-nickname', {
        nickname: nickname
      }, {
        headers: headers
      })
  ...
  memberdetails(id) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/member-details', {
        memberId: id
      }, {
        headers: headers
      })
  ...
  sendMessage(msg) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/send-message', { msg: msg }, {
        headers: headers
      })
      .map(res => res.json());
  }
  ...
  getUnreadMessages(userId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/get-nbunread-messages', {
        userId: userId
      }, {
        headers: headers
      })
  ...
  getMessageFlow(threadId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/get-thread-messages', {
        threadId: threadId
      }, {
        headers: headers
      })
  ...
  getMessengerContactList() {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/get-messenger-contact-list', {
        userId: userId
      }, {
        headers: headers
      })
  ...
  setReadStatus(threadId, userId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/set-thread-readstatus', {
        userId: userId,
        threadId: threadId
      }, {
        headers: headers
  ...
  */
  removeReadStatus(threadId, userId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/remove-thread-readstatus', {
        userId: userId,
        threadId: threadId
      }, {
        headers: headers
  ...
  getNbUseregistred() {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .get(environment.BACKENDURL + '/user/getNbUseregistred', {
        headers: headers
      })
      .map(res => res.json());
  }
 ...
 */
  getNbTravelsegistred() {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .get(environment.BACKENDURL + '/user/getNbTravelsegistred', {
        headers: headers
      })
      .map(res => res.json());
  }
  ...
  addFollow(userId, friendId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/add-friend', {
        userId: userId,
        friendId: friendId
      }, {
        headers: headers
  ...
  showWaitingFriendsDemand(userId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/show-waiting-friends-demand', {
        userId: userId
      }, {
        headers: headers
      })
  ...
  */
  acceptDemand(friendDemandId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/accept-friend-demand', {
  ...
  */
  refusedDemand(friendDemandId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/refuse-friend-demand', {
        friendDemandId: friendDemandId
      }, {
        headers: headers
      })
  ...
  */
  nbWaintingFriendDemand(userId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/nbWaintingFriendDemand', {
        userId: userId
      }, {
        headers: headers
      })
  ...
  unFollow(userId, friendId) {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .post(environment.BACKENDURL + '/user/remove-friend', {
        userId: userId,
        friendId: friendId
      }, {
        headers: headers
  ...
  getNbOnlineUsers() {
    ...
    headers.append('Content-type', 'application/json');
    return this._http
      .get(environment.BACKENDURL + '/user/nb-online', {
        headers: headers
      })
      .map(res => res.json());
