...
router.post('/add_friend/:friend', passport.authenticate('jwt', { session: false }), function (req, res, next) {
    res.json({
        status: true,
...
router.post('/lost_password', passport.authenticate('jwt', { session: false }), function (req, res, next) {
    res.json({
        status: true,
