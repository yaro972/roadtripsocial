...
var api = require('./app/controllers/V1/api');
var userApi = require('./app/controllers/V1/user');
var admin = require('./app/controllers/V1/admin');
var chat = require('./app/controllers/V1/chat');
